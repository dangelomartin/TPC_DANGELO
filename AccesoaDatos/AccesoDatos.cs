...
namespace AccesoDatos
{
    ...
    public class AccesoDatosMaster
    {
        public static string cadenaConexion = "data source=(local); initial catalog=DANGELO_DB; integrated security=sspi";
